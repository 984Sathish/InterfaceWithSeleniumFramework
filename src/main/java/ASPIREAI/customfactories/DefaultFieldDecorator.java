 ...
 * {@literal @FindBy}, {@literal @FindBys}, or {@literal @FindAll} annotation
 * with a proxy that locates the elements using the passed in
...
public class DefaultFieldDecorator implements FieldDecorator {
	...
	protected boolean isDecoratableList(Field field) {
		...
		if (field.getAnnotation(FindBy.class) == null && field.getAnnotation(FindBys.class) == null
				&& field.getAnnotation(FindAll.class) == null && field.getAnnotation(IFindBy.class) == null
