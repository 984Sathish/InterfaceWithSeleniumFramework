...
public interface WebDriverEventListener {
	 ...
	 */
	// Previously: Called after {@link WebDriver#executeScript(String)}. Not called
	 ...
	 * {@link org.openqa.selenium.WebDriver.TargetLocator#window(String)}
	 *
	 * @param windowName The name of the window or the handle as returned by
	 *                   {@link org.openqa.selenium.WebDriver#getWindowHandle()} or
	...
	/**
	 * Called before
	 * {@link org.openqa.selenium.TakesScreenshot#getScreenshotAs(OutputType)}
	 ...
	 * Called after
	 * {@link org.openqa.selenium.TakesScreenshot#getScreenshotAs(OutputType)}
	 * allows the implementation to determine which type of output was generated and
	 * to access the output itself
	 *
	 * @param <X>        Return type for getScreenshotAs.
	 * @param target     target type, @see OutputType
	 ...
	 * @param element - {@link WebElement} against which call is being made
	 * @param driver  - instance of {@link WebDriver}
	 * @param text    - {@link String} object extracted from respective
	 *                {@link WebElement}
	 */
